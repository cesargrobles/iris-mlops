...
"""
Educational Goal:
- Why this module exists in an MLOps system: Define feature engineering rules as a reusable recipe
  that can be fitted safely on training data only.
...
def get_feature_preprocessor(
    ...
    # Only configured columns enter the model; unexpected columns are ignored
